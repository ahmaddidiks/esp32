 ...
 * @param arg data, aside from event data, that passed to the handler when it is called
 * @param event_base the base data of the event to register the handler for
...
static void wifi_app_default_wifi_init(void)
{
	...
	// Default WiFi configuration - operation must be in this order!
...
//					http_server_start();
				...
				case WIFI_APP_CONNECTING_FROM_HTTP_SERVER:
					ESP_LOGI(TAG, "WIFI_APP_CONNECTING_FROM_HTTP_SERVER");
					break;
